    ...
    <div className="min-h-screen pb-24 gradient-male">
      <div className="max-w-screen-xl mx-auto p-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Card className="gradient-card card-shadow border-white/10 p-6 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold">Pro Athlete</h2>
            </div>
            
            <div className="mb-6">
              <div className="text-4xl font-bold mb-1">€19,99<span className="text-lg font-normal text-muted-foreground">/mo</span></div>
          ...
          <Card className="gradient-card card-shadow border-white/10 p-6 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold">Pro Nutrition</h2>
            </div>
            
            <div className="mb-6">
              <div className="text-4xl font-bold mb-1">€14,99<span className="text-lg font-normal text-muted-foreground">/mo</span></div>
              <p className="text-sm text-muted-foreground">
                {isGerman ? "12 Monate Abo • nach 6 Monaten kündbar" : "12 months • cancellable after 6 months"}
              </p>
            </div>
